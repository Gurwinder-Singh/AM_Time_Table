...
//                    error.put(getKey(sc, y.indexOf(a)),( error.get(getKey(sc, y.indexOf(a)))==null?1:error.get(getKey(sc, y.indexOf(a))) +1));
                    if (a.getError() == 2) {
...
//                        if (config.getMax_generations() -300  < error.get(getKey(sc, y.indexOf(a))) ) {
//                            if (y.indexOf(a) != 0) {
//                                ArrayList<TimeTableDetail> td1 = selectTournamentTimeTable(pop);
//                                ArrayList<TimeTableDetail> td2 = selectTournamentTimeTable(pop);
//                                y.set(y.indexOf(a)-1, crossoverTimeTable(td1, td2).get(y.indexOf(a)));
//                            }
//                        }
                        ArrayList<TimeTableDetail> td1 = selectTournamentTimeTable(pop);
                        ArrayList<TimeTableDetail> td2 = selectTournamentTimeTable(pop);
