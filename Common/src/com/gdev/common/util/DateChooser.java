...
/**
 * Custom dialog box to enter dates. The <code>DateChooser</code> class presents a calendar and allows the user to
 * visually select a day, month and year so that it is impossible to enter an invalid date.
 * 
 * @author Saurabh
 */
public class DateChooser extends JDialog implements ItemListener, MouseListener, FocusListener, KeyListener,
	 ...
	 * in the calendar ({@link #days}), corresponding to a given day.
	 */
	private int offset;
	...
	/**
	 * Initializes this <code>DateChooser</code> object. Creates the controls, registers listeners and initializes the
	 * dialog box.
	 */
	...
	/**
	 * Gets the selected day, as an <code>int</code>. Parses the text of the selected label in the calendar to get
	 * the day.
	 * 
	...
	/**
	 * Selects a date. Displays the dialog box, with a given date as the selected date, and allows the user select a new
	 * date.
	 * 
	...
	public Date select(Point point, Date dt) {
